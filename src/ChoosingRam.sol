...
contract ChoosingRam {
    ...
    //the caller has to be the challenger.
    //@audit - high: isRamSelected is not getting updated when a ram is selected.
    function increaseValuesOfParticipants(uint256 tokenIdOfChallenger, uint256 tokenIdOfAnyPerticipent)
        public
        RamIsNotSelected
    {
        //q what happens if a user puts in an invalid tokenIdofAnyPerticipent?
        //@audit - high: User can put an invalid tokenIdOfChallenger and tokenIdofAnyPerticipent.
